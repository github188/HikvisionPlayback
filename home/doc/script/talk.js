...
function InitPattern() {
	$.ajax({
		...
		url: "Preview.ashx",
		data: "method=" + m_lHttp + m_szHostName + ":" + m_lHttpPort + "/PSIA/Custom/SelfExt/PTZ/channels/1/patterns",
		success: function(xmlDoc, textStatus, xhr) {
...
function GetPatrolsCab() {
	$.ajax({
	    ...
	    url: "Preview.ashx",
	    data: "method=" + m_lHttp + m_szHostName + ":" + m_lHttpPort + "/PSIA/PTZ/channels/1/patrols",
	    async: true,
	    timeout: 30000,
	    /*beforeSend: function(xhr) {
			xhr.setRequestHeader("If-Modified-Since", "0");
...
function GetTalkNum() {
	$.ajax({
		...
		url: "Preview.ashx",
		data: "method=" + m_lHttp + m_szHostName + ":" + m_lHttpPort + "/PSIA/Custom/SelfExt/TwoWayAudio/channels",
		async: false,
		/*beforeSend: function(xhr) {
			xhr.setRequestHeader("If-Modified-Since", "0");
			xhr.setRequestHeader("Authorization", "Basic " + m_szUserPwdValue);
