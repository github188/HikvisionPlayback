...
function getUPnPInfo()
{
	$.ajax({
		...
		url: "Configuration.ashx?method=" + m_lHttp + m_szHostName + ":" + m_lHttpPort + "/PSIA/System/interfaces",
		async: false,
		...
		success: function(xmlDoc, textStatus, xhr) {
			...
			if($.inArray(m_szHostName, szIPArray) == -1) {
				$.ajax({
					...
					url: "Configuration.ashx?method=" + m_lHttp + m_szHostName + ":" + m_lHttpPort + "/PSIA/Custom/SelfExt/UPnP/ports/status",
					async: false,
					/*beforeSend: function(xhr) {
						xhr.setRequestHeader("If-Modified-Since", "0");
						xhr.setRequestHeader("Authorization", "Basic " + ("anonymous:\177\177\177\177\177\177" === Base64.decode(m_szUserPwdValue)?"":m_szUserPwdValue));
...
function GetRTSPPort()
{
	$.ajax({
		type: "GET",
		url: "Configuration.ashx?method=" + m_lHttp + m_szHostName + ":" + m_lHttpPort + "/PSIA/Streaming/channels",
		async: false,
		beforeSend: function(xhr) {
			xhr.setRequestHeader("If-Modified-Since", "0");
			xhr.setRequestHeader("Authorization", "Basic " + ("anonymous:\177\177\177\177\177\177" === Base64.decode(m_szUserPwdValue)?"":m_szUserPwdValue));
...
function GetRTSPPortDyn()
{
	$.ajax({
		type: "GET",
		url: "Configuration.ashx?method=" + m_lHttp + m_szHostName + ":" + m_lHttpPort + "/PSIA/Custom/SelfExt/ContentMgmt/DynStreaming/channels",
		async: false,
		beforeSend: function(xhr) {
			xhr.setRequestHeader("If-Modified-Since", "0");
			xhr.setRequestHeader("Authorization", "Basic " + m_szUserPwdValue);
