...
<script type="text/javascript">
   // debugger;
        ...
        var m_lHttp = "http://";
        var m_lRtspPort = String('<%=m_lRtspPort%>');
       // var m_szUserPwdValue = String(<%=m_szUserPwdValue%>);
</script>
...
<body onload="InitPreview()" onunload="UnloadPage('preview.aspx',1)">
...
<div id="content" class="contentleft">
    <div id="dvChangeSize" class="toptoolbar" style="display:none; ">
