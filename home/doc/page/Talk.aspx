...
<script type="text/javascript" src="../script/commontalk.js"></script>
...
<body onload="InitTalk()" onunload="UnloadPage('Talk.aspx',1)" >
...
<div id="EditVoiceTalk">
    ...
    <div>
        ...
        <span class="frameCenMid">
            ...
            <div align="center" class="elm">
                <input name="Num2" id="Num2" type="checkbox"  value="0" onclick="SelectTalk(2)" >&nbsp;<label id="Label1" name="laTalkNum"></label>2
            </div>     
            <div align="center">
                <span align="center">
                    <div onclick="onVoiceTalkDlgOk()">
                        <span class="BtnLeft"></span>
                        <span class="BtnMid"><label id="Label2" name="laOK"></label></span>
                        <span class="BtnRight"></span>
                    </div>
                </span>
                <span align="center">
                    <div onclick="$.modal.impl.close()">
                        <span class="BtnLeft"></span>
                        <span class="BtnMid"><label id="Label3" name="laCancel"></label></span>
                        <span class="BtnRight"></span>
                    </div>
                </span>
            </div>
    ...
    <table style="width:0%; height:0%; border-color:red;" >
        <tr style="width:0%; height:0%;">
            <td style="width:0%;"><table style="width:0%; height:0%;"><tr><td style="width:0%; height:0%;" id="main_plugin">
               </td></tr></table></td>
        </tr>
    </table>
